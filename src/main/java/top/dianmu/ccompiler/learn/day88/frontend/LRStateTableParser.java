package top.dianmu.ccompiler.learn.day88.frontend;
import java.util.HashMap;
import java.util.Stack;

import top.dianmu.ccompiler.learn.day88.backend.CodeTreeBuilder;
...
public class LRStateTableParser {
    ...
    private void takeActionForReduce(int productNum) {
    	...
    	case CGrammarInitializer.VarDecl_Equal_Initializer_TO_Decl:
    		...
    		//那么上面执行 top.dianmu.ccompiler.day65.top.dianmu.ccompiler.day66.top.dianmu.ccompiler.day67.top.dianmu.ccompiler.day68.top.dianmu.ccompiler.day70.Symbol symbol = (top.dianmu.ccompiler.day65.top.dianmu.ccompiler.day66.top.dianmu.ccompiler.day67.top.dianmu.ccompiler.day68.top.dianmu.ccompiler.day70.Symbol)attributeForParentNode; 会出错
