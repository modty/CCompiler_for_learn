...
import top.dianmu.ccompiler.learn.day88.backend.ClibCall;
	...
	private void handleDublicateSymbol(Symbol symbol, ArrayList<Symbol>symList) {
		...
		while (it.hasNext()) {
			...
			if (sym.equals(symbol) == true) {
				...
				System.err.println("top.dianmu.ccompiler.day65.top.dianmu.ccompiler.day66.top.dianmu.ccompiler.day67.top.dianmu.ccompiler.day68.top.dianmu.ccompiler.day70.Symbol definition replicate: " + sym.name);
				System.exit(1);
			}
		}
