package top.dianmu.ccompiler.learn.day19.InputSystem;
...
public class InputSystem {
    ...
    public static void main(String[] args) {
    	top.dianmu.ccompiler.learn.day25.InputSystem.InputSystem input = new top.dianmu.ccompiler.learn.day25.InputSystem.InputSystem();
